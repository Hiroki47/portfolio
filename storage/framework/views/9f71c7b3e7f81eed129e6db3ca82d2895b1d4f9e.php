    ...
    <div class="mb-3">
        ...
        <div class="form-check form-check-inline">
            <?php if(in_array($category->id, $selected_categories)): ?>
                <input type="checkbox" name="category[]" value="<?php echo e($category->id); ?>" id="<?php echo e($category->name); ?>" class="form-check-input" checked>
            <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <textarea name="description" id="description" rows="3" class="form-control" placeholder="What's on your mind"><?php echo e(old('description', $post->description)); ?></textarea>
        <!-- Error -->
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row mb-3">
        <div class="col-6">
            ...
            <img src="<?php echo e(asset('storage/images/' . $post->image)); ?>" alt="<?php echo e($post->image); ?>" class="img-thumbnail w-100">
            <input type="file" name="image" class="form-control mt-1" aria-describedby="image-info">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /work/resources/views/users/posts/edit.blade.php ENDPATH**/ ?>